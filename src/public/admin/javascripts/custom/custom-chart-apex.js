...
$(document).ready(function () {
    ...
    var chart = new ApexCharts(
        document.querySelector('#apex-range-column-chart'),
        options
    );
    chart.render();
    ...
    var chart = new ApexCharts(
        document.querySelector('#apex-line-column-area-chart'),
        options
    );
    chart.render();
    ...
    var chart = new ApexCharts(
        document.querySelector('#apex-circle-chart-custom-angel-chart'),
        options
    );
    chart.render();
});
